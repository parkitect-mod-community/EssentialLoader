...
namespace ParkitectAssetEditor
{
	...
	public class Asset
	{
        ...
        /// The type of asset
        /// </summary>
        private AssetType _assetType = AssetType.Deco;
        ...
        public int Type
        {
            get
            {
                if (_assetType == AssetType.Shop || _assetType == AssetType.Generic)
                {
                    // use a very large value so asset manager drops out loading the model
                    return 255;
                }

                return (int) _assetType;
            }
        }

        [JsonConverter(typeof(StringEnumConverter))]
        public AssetType TargetType
        {
